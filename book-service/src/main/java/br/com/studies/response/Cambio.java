package br.com.studies.response;
...
public class Cambio implements Serializable {
	...
	public Cambio(Long id, String from, String to, Double converseFactor, Double convertedValue,
			String environment) {
		this.id = id;
		this.from = from;
		this.to = to;
		this.conversionFactor = converseFactor;
	...
	public void setConversionFactor(Double converseFactor) {
		this.conversionFactor = converseFactor;
	}
