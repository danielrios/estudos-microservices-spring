...
public class Cambio implements Serializable {
	...
	public Cambio(Long id, String from, String to, BigDecimal converseFactor, BigDecimal convertedValue,
			String environment) {
		this.id = id;
		this.from = from;
		this.to = to;
	...
	public void setConversionFactor(BigDecimal converseFactor) {
		this.conversionFactor = converseFactor;
	}
